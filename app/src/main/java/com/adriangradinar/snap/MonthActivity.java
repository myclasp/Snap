...
public class MonthActivity extends AppCompatActivity {
    ...
    public void setView(){
        Utils.checkRunningThread(TAG);
        materialCalendarView = (MaterialCalendarView) findViewById(R.id.calendarView);
        materialCalendarView.setSelectedDate(Calendar.getInstance());
        materialCalendarView.setOnDateChangedListener(new OnDateSelectedListener() {
            @Override
            public void onDateSelected(@NonNull MaterialCalendarView widget, @NonNull CalendarDay date, boolean selected) {
                Toast.makeText(getApplicationContext(), "This will navigate to the selected day - " + materialCalendarView.getSelectedDate().toString(), Toast.LENGTH_SHORT).show();
